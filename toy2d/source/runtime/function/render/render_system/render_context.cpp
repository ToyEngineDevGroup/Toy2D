...
namespace Toy2D {
        ...
        // Create frame resources.
        {
            ...
            for (uint32_t n = 0; n < s_frame_count; ++n) {
                ...
                FrameBufferConfiguration fb_config{
                    ...
                    s_colorFormat};
                m_frameBuffers[n] = Toy2D::CreateScope<FrameBuffer>(fb_config);
            ...
            m_frameResourceMngr = Toy2D::CreateScope<DXFrameResMngr>(s_frame_count, m_device.Get());
        }
    ...
    void RenderContext::registerRenderPass() {
        ...
        m_render_passes.push_back(Toy2D::CreateScope<MainCameraPass2D>());
        m_render_passes.push_back(Toy2D::CreateScope<UIPass>());
