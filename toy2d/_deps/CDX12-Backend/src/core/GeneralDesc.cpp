...
D3D12_SHADER_RESOURCE_VIEW_DESC CDX12::Desc::SRV::Tex2D(DXGI_FORMAT format, UINT MipLevels) {
...
D3D12_SHADER_RESOURCE_VIEW_DESC CDX12::Desc::SRV::Tex3D(DXGI_FORMAT format, UINT MipLevels) {
    D3D12_SHADER_RESOURCE_VIEW_DESC srvDesc;
    ZeroMemory(&srvDesc, sizeof(D3D12_SHADER_RESOURCE_VIEW_DESC));
    srvDesc.Shader4ComponentMapping       = D3D12_DEFAULT_SHADER_4_COMPONENT_MAPPING;
    srvDesc.Format                        = format;
...
D3D12_SHADER_RESOURCE_VIEW_DESC CDX12::Desc::SRV::TexCube(DXGI_FORMAT format, UINT MipLevels) {
    D3D12_SHADER_RESOURCE_VIEW_DESC srvDesc;
    ZeroMemory(&srvDesc, sizeof(D3D12_SHADER_RESOURCE_VIEW_DESC));
    srvDesc.Format                          = format;
...
D3D12_DEPTH_STENCIL_VIEW_DESC CDX12::Desc::DSV::Basic(DXGI_FORMAT format) {
...
D3D12_GRAPHICS_PIPELINE_STATE_DESC CDX12::Desc::PSO::Basic(
...
D3D12_RENDER_TARGET_VIEW_DESC CDX12::Desc::RTV::Tex2DofTexCube(
    DXGI_FORMAT format,
    UINT        Index,
    UINT        MipSlice) {
...
D3D12_GRAPHICS_PIPELINE_STATE_DESC CDX12::Desc::PSO::MRT(
    ID3D12RootSignature*            rootSig,
    const D3D12_INPUT_ELEMENT_DESC* pInputElementDescs, UINT NumElements,
    const ID3DBlob* VS,
    const ID3DBlob* PS,
...
D3D12_RESOURCE_DESC CDX12::Desc::RSRC::Basic(
...
D3D12_RESOURCE_DESC CDX12::Desc::RSRC::RT2D(
    UINT64      Width,
    UINT        Height,
    DXGI_FORMAT format) {
...
D3D12_RESOURCE_DESC CDX12::Desc::RSRC::TextureCube(
    UINT64               Width,
    UINT                 Height,
    UINT                 MipLevels,
    DXGI_FORMAT          format,
